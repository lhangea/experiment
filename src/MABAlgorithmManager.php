...
class MABAlgorithmManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, LanguageManager $language_manager, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/MABAlgorithm', $namespaces, $module_handler, 'Drupal\experiment\Annotation\MABAlgorithm');
    $this->alterInfo('mab_algorithm_info');
    $this->setCacheBackend($cache_backend, $language_manager, 'mab_algorithm_info_plugins');
  }
