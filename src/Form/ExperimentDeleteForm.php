...
/**
 * @file
 * Contains Drupal\experiment\Form\ExperimentDeleteForm.
 */
...
/**
 * Class ExperimentDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from ExperimentFormBase. The reason for
 ...
 * @ingroup experiment
 */
class ExperimentDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete experiment %label?', array(
  ...
  public function getConfirmText() {
    return $this->t('Delete Experiment');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.experiment.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Experiment %label was deleted.', array(
      '%label' => $this->entity->label(),
    )));
